...
git clone https://github.com/RHShamil/Automate_MySQL_NodeJS_Setup /tmp/scripts

chmod +x /tmp/scripts/mysql-setup.sh
bash /tmp/scripts/mysql-setup.sh
'''
...
nodejs = aws.ec2.Instance(
    'nodejs-server',
    instance_type='t2.small',
    ami='ami-0672fd5b9210aa093',  # Update with correct Ubuntu AMI ID
    subnet_id=public_subnet.id,
    key_name="db-cluster",
